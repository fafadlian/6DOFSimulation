...
*	 This Version (Joint Space & Task Space Combination) was built by : 
...
void keyboard(unsigned char key, int i, int j)
{
  ...
  //manual
    case 'z': q1 += 10*DTR, gerak=3; break;
    case 'Z': q1 += -10*DTR, gerak=3; break;
    case 'x': q2 += 10*DTR, gerak=3; break;
    case 'X': q2 += -10*DTR, gerak=3; break;
    case 'c': q3 += 10*DTR, gerak=3; break;
    case 'C': q3 += -10*DTR, gerak=3; break;
    case 'v': q4 += 10*DTR, gerak=3; break;
    case 'V': q4 += -10*DTR, gerak=3; break;
    case 'b': q5 += 10*DTR, gerak=3; break;
    case 'B': q5 += -10*DTR, gerak=3; break;
    case 'n': q6 += 10*DTR, gerak=3; break;
    case 'N': q6 += -10*DTR, gerak=3; break;
	//arah gerak
	//Kamera	
